...
export const metadata: Metadata = {
  ...
  description: 'Self-taught Digital Designer with 5+ years experience specialising in Website Design, UI/UX, and Brand Identity. View my portfolio featuring projects for major brands like Haval, PG Bison, and Stargas.',
