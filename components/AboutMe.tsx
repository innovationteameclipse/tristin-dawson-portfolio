    ...
    <section id="about" className="mb-16">
      <div className="max-w-4xl mx-auto px-8 text-center">
        ...
        <p className="text-lg text-neutral-300 leading-relaxed mt-4">
          When I'm not designing, you'll find me carp fishing by the water or immersed in hardcore survival games and first-person shooters. I'm passionate about gaming and enjoy exploring challenging and immersive gaming experiences.
        </p>
      </div>
    </section>
  )
